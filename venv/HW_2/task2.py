...
if str_1st_int[1] == str_2nd_int[1]:
    ...
    rn = int(common_denominator / str_1st_int[1] * str_1st_int[0] + common_denominator/ str_2nd_int[1] * str_2nd_int[0])
    g2 = gcd(rn, common_denominator)
    new_numerator = int(rn / g2)
    new_denominator = int(common_denominator / g2)

    print(f'Результат сложения дробей: {new_numerator}/{new_denominator}')
